...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:location.protocol+'//'+RESURL+"/img/tuan/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,imageManagerPath:location.protocol+'//'+RESURL+"/img/tuan/"                                    //图片修正地址，同imagePath
