...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["fullscreen","insertunorderedlist","insertorderedlist","insertimage","date","time","map","spechars","bold","italic","underline","strikethrough","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","indent","removeformat","formatmatch","autotypeset","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells"]]
