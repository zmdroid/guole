(function($) {
	...
	$.extend(Wysiwyg.prototype, {
		...
		init: function(element, options) {
			...
			var newX = 0;//element.width || element.clientWidth || 0;
			var newY = 0;//element.height || element.clientHeight || 0;
		...
		initFrame: function() {
			...
			this.editorDoc.open();
			this.editorDoc.write(this.options.html.replace(/INITIAL_CONTENT/,
			function() {
		...
		appendMenu: function(cmd, args, className, fn, tooltip) {
			var self = this;
			args = args || [];
			$('<li></li>').append($('<a role="menuitem" tabindex="-1" href="javascript:;">' + (className || cmd) + '</a>').addClass(className || cmd).attr('title', tooltip)).click(function() {
				if (fn) {
					fn.apply(self)
				} else {
					self.withoutCss();
		...
		appendControls: function() {
			for (var name in this.options.controls) {
				...
				if (control.separator) {
					...
					this.appendMenu(control.command || name, control.arguments || [], control.className || control.command || name || 'empty', control.exec, control.tooltip || control.command || name || '')
				}
			}
		},
