...
jQuery(function($) {
	...
	function initModal() {
		...
		if (!modal.full) {
			...
			contain.append($('<div id="nyroModalFull" style="z-index:998"><div id="nyroModalBg"></div><div id="nyroModalWrapper"><div id="nyroModalContent"></div></div><div id="nyrModalTmp"></div><div id="nyroModalLoading"></div></div>').hide());
