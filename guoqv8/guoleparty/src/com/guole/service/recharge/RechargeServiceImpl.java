...
public class RechargeServiceImpl implements RechargeService {
	...
	public boolean giftCardRecharge(int userId,GiftCardVO giftCardVO) throws Exception {
		...
		//获取礼品卡类型
		GiftCardTypeVO cardType = giftCardService.getGiftCardTypeByTypeId(giftCardVO.getCardType());
		...
		giftCardVO.setCardType(cardType.getId());
		giftCardVO.setMoney(cardType.getMoney());
		giftCardVO.setUserId(userId);
